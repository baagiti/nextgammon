...
// CPU move selection lives in ./cpuAI.ts (a ported 2-ply engine) — it's the sole consumer of
// getValidMoves/executeMove for search purposes, so keeping it out of this file avoids a cycle.
